 ...
 */
@PerActivity
@Component(dependencies = arrayOf(AppComponent::class), modules = arrayOf(SecondActivityModule::class, ActivityModule::class))
interface SecondActivityComponent : BaseActivityComponent {
    fun inject(activity: SecondMvpActivity)
